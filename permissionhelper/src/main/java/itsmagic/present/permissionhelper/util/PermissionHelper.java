...
public class PermissionHelper {
    ...
    public static class Builder {
        ...
        private OnShouldShowPermissionInfoListener getOnShouldShowPermissionInfoListener() {
            return mShouldShowPermissionInfoListener;
        }

        /** Obtain the listener when all requested permission is granted */
        private OnPermissionGrantedListener getOnPermissionGrantedListener() {
            return mPermissionGrantedListener;
        }

        /** Obtain the listener when some permission is denied */
        private OnPermissionDeniedListener getOnPermissionDeniedListener() {
