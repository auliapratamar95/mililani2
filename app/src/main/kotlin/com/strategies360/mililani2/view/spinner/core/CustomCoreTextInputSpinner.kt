...
import com.strategies360.mililani2.adapter.spinner.CustomTextInputSpinnerAdapter
import itsmagic.present.easierspinner.RefreshableEasierSpinnerCore

abstract class CustomCoreTextInputSpinner<DATA_TYPE> : RefreshableEasierSpinnerCore<DATA_TYPE> {

    lateinit var adapter: CustomTextInputSpinnerAdapter<DATA_TYPE>
    ...
    private fun initAdapter() {
        adapter = CustomTextInputSpinnerAdapter(context)
        setAdapter(adapter)
    }
