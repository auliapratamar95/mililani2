...
import com.strategies360.mililani2.adapter.recycler.SelectLocationAdapter.ViewHolder
...
class SelectLocationAdapter : DataListRecyclerViewAdapter<SelectLocation, ViewHolder>() {
  ...
  inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    fun bindView() {
      ...
      itemView.txt_value.text = data.valueLocation
    }
  }
}