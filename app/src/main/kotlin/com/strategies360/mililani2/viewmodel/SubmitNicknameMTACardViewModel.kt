...
class SubmitNicknameMTACardViewModel : ViewModel() {
    ...
    fun editNicknameMtaCard(cardNumber: String, mtaCardRequest: MTACardRequest) {
        ...
        apiCaller?.editNicknameMTACard(cardNumber, mtaCardRequest)
    }

    fun cancelSubmitNicknameMTACArd() {
        apiCaller?.cancel()
    }
}
