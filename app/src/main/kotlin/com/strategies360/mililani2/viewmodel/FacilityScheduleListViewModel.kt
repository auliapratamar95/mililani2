...
class FacilityScheduleListViewModel : ViewModel(), LifecycleObserver {

    /** The LiveData for resource state */
    val resource = MutableLiveData<Resource<FacilityScheduleList>>()

    /** The LiveData for list of sample products */
    val dataList = MutableLiveData<List<FacilityScheduleFile>>()
    ...
    fun fetchFromRemote() {
        ...
        apiService.getFacilitySchedule()
                .observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
                .subscribe(object : CustomObserver<Any>() {
                    override fun onSuccess(response: Any) {
                        val dataResponse = response as List<FacilityScheduleFile>
