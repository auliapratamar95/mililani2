...
class EventsResultActivity : CoreActivity() {

  override val viewRes: Int = R.layout.activity_events_result
  ...
  companion object {
    ...
    fun launchIntent(context: Context) {
      val intent = Intent(context, EventsResultActivity::class.java)
