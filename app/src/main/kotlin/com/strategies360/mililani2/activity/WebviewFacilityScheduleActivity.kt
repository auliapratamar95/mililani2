...
class WebviewFacilityScheduleActivity : CoreActivity() {
  var prDialog: ProgressDialog? = null
  override val viewRes: Int
    get() = R.layout.activity_webview_facility_schedule
...
//    web_view.webViewClient = CustomWebClient(prDialog!!)
    ...
    web_view.webViewClient = object : WebViewClient() {
      override fun shouldOverrideUrlLoading(view: WebView?, request: WebResourceRequest?): Boolean {
        ...
        view?.loadUrl("https://mililani.dev.s360.is/wp-admin/admin.php?page=acf-options-theme-settings")
  ...
  companion object {
    ...
    fun launchIntent(context: Context) {
      val intent = Intent(context, WebviewFacilityScheduleActivity::class.java)
