...
import kotlinx.android.synthetic.main.activity_webview_history.*
import kotlinx.android.synthetic.main.include_toolbar.*


class WebviewHistoryActivity : CoreActivity() {
  var prDialog: ProgressDialog? = null
  override val viewRes: Int
    get() = R.layout.activity_webview_history
...
//    web_view.webViewClient = CustomWebClient(prDialog!!)
    ...
    web_view.webViewClient = object : WebViewClient() {
      override fun shouldOverrideUrlLoading(view: WebView?, request: WebResourceRequest?): Boolean {
        ...
        view?.loadUrl("https://www2.mililanitown.org/wbwsc/webtrac.wsc/login.html?LoginRedirect=history.html&LoginRedirectParam1=HistoryOption&LoginRedirectValue1=inquiry")
    ...
    web_view.loadUrl("https://www2.mililanitown.org/wbwsc/webtrac.wsc/login.html?LoginRedirect=history.html&LoginRedirectParam1=HistoryOption&LoginRedirectValue1=inquiry")
  ...
  companion object {
    ...
    fun launchIntent(context: Context) {
      val intent = Intent(context, WebviewHistoryActivity::class.java)
