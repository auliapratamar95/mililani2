...
class ReservationWebviewFragment : CoreFragment() {

    override val viewRes: Int
        get() = R.layout.fragment_webview_reservation
    ...
    private fun initView() {
        ...
        webview_classes.webViewClient = object : WebViewClient() {
            override fun shouldOverrideUrlLoading(view: WebView?, request: WebResourceRequest?): Boolean {
                view?.loadUrl(getString(R.string.reservations))
                return true
            }
        ...
        webview_classes.loadUrl(getString(R.string.url_reservation))
    }
}