...
class ResultTicketsFragment : DataListFragment() {
  ...
  override val viewRes: Int = R.layout.fragment_events_result
  ...
  override fun initRecyclerAdapter(): DataListRecyclerViewAdapter<Any, ViewHolder> {
    ...
    adapter.setDiffUtilNotifier { oldList, newList ->
      Events.DiffUtilCallback(oldList, newList)
    }
