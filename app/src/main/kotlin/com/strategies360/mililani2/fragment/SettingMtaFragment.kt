...
class SettingMtaFragment : CoreFragment(), View.OnClickListener {
...
//            NewsActivity.launchIntent(requireContext())
    ...
    private fun getCategoryQuickLink() {
        if (Hawk.contains(Constant.KEY_CATEGORY_QUICK_LINK_LIST)) {
            ...
            if (listCategoryQuickLink.size < 4 || listCategoryQuickLink.size == 4) {
                ...
                for (i in listCategoryQuickLink.indices) {
                    when (i + 1) {
                        1 -> {
                            ...
                            showIconQuickLinkOne(listCategoryQuickLink[i].id, img_quick_link_one, txt_quick_link_one, 1)
                        }
                        2 -> {
                            ...
                            txt_quick_link_one.visibility = View.VISIBLE
                            showIconQuickLinkOne(listCategoryQuickLink[i].id, img_quick_link_two, txt_quick_link_two,2)
                        }
                        3 -> {
                            ...
                            txt_quick_link_one.visibility = View.VISIBLE
                            showIconQuickLinkOne(listCategoryQuickLink[i].id, img_quick_link_three, txt_quick_link_three, 3)
                        }
                        4 -> {
                            ...
                            txt_quick_link_one.visibility = View.VISIBLE
                            showIconQuickLinkOne(listCategoryQuickLink[i].id, img_quick_link_four, txt_quick_link_four, 4)
                        }
                    }
                }
            } else {
