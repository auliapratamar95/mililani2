...
public class ImagePicker {
    ...
    private void initDefaultValues() {
        if (mSelectedDirectory == null) {
            final String appPackage = mActivity.getPackageName();
            mSelectedDirectory = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES) + "/" + appPackage + "/imagepicker");
