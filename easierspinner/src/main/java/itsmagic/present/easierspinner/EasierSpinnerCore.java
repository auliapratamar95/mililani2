...
public abstract class EasierSpinnerCore<DATA_TYPE> extends FrameLayout {
    ...
    private void initEasierSpinner(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            initEasierSpinnerAttributeSet(context, attr);
        ...
        mSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (!isInitialItemSelectionInitialization) {
                    ...
                    mSpinner.initializeEasierSpinnerCore(position);
     ...
     * @return The selected item position, or -1 if no item is selected
     */
    public int getSelectedItemPosition() {
        if (isItemSelected) return mSpinner.getSelectedItemPosition();
        else return -1;
    }
    ...
    public void showSelection() {
        if (mSpinner.isEnabled() && mSpinner.getWindowToken() != null) {
    ...
    public void setDropdownWidth(int width) {
        mSpinner.setDropDownWidth(width);
    }
