...
public class CustomSpinner extends Spinner {
    ...
    private void callSelectedListener(int position) {
        boolean sameSelected = position == mPreviousSelection;
    ...
    /** Do not call this method! This is used for this library's initialization */
    public void initializeEasierSpinnerCore(int position) {
        mPreviousSelection = position;
    }
